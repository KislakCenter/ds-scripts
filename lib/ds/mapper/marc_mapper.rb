  ...
  module Mapper
    ...
    class MarcMapper < DS::Mapper::BaseMapper
      ...
      def map_record entry
        ...
        production_date_as_recorded        = DS::MarcXml.extract_production_date_as_recorded(record).join '|'
        ...
        uniform_title_as_recorded          = DS::MarcXml.extract_uniform_titles_as_recorded(record).join '|'
