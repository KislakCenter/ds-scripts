  ...
  module Mapper
    ...
    class DSCSVMapper < DS::Mapper::BaseMapper
      ...
      def map_record entry
        ...
        century                            = ''
        century_aat                        = ''
        production_place_as_recorded       = DS::DSCSV.extract_production_place_as_recorded(record).join '|'
        ...
        uniform_title_as_recorded          = DS::DSCSV.extract_uniform_title_as_recorded(record).join '|'
        uniform_title_agr                  = DS::DSCSV.extract_uniform_title_as_recorded_agr(record).join '|'
        title_as_recorded                  = DS::DSCSV.extract_title_as_recorded(record).join '|'
        title_as_recorded_agr              = DS::DSCSV.extract_title_as_recorded_agr(record).join '|'
        standard_title                     = Recon::Titles.lookup(title_as_recorded.split('|'), column: 'structured_value').join '|'
        genre_as_recorded                  = DS::DSCSV.extract_genre_as_recorded(record).join '|'
        ...
        subject_as_recorded                = DS::DSCSV.extract_subject_as_recorded(record).join '|'
        ...
        author_as_recorded                 = DS::DSCSV.extract_author_as_recorded(record).join '|'
        author_as_recorded_agr             = DS::DSCSV.extract_author_as_recorded_agr(record).join '|'
        ...
        artist_as_recorded                 = DS::DSCSV.extract_artist_as_recorded(record).join '|'
        artist_as_recorded_agr             = DS::DSCSV.extract_artist_as_recorded_agr(record).join '|'
        ...
        scribe_as_recorded                 = DS::DSCSV.extract_scribe_as_recorded(record).join '|'
        scribe_as_recorded_agr             = DS::DSCSV.extract_scribe_as_recorded_agr(record).join '|'
        scribe_wikidata                    = ''
        scribe                             = ''
        ...
        former_owner_as_recorded           = DS::DSCSV.extract_former_owner_as_recorded(record).join '|'
        former_owner_as_recorded_agr       = DS::DSCSV.extract_former_owner_as_recorded_agr(record).join '|'
        ...
        material_as_recorded               = DS::DSCSV.extract_material_as_recorded(record).join '|'
        ...
        note                               = DS::DSCSV.extract_note(record).join '|'
