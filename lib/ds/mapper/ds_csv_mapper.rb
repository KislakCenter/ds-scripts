  ...
  module Mapper
    ...
    class DSCSVMapper < DS::Mapper::BaseMapper
      ...
      def map_record entry
        ...
        production_date                    = DS::Extractor::DsCsvExtractor.extract_date_range(record).join '^'
        century                            = DS.transform_dates_to_centuries production_date
        century_aat                        = DS.transform_centuries_to_aat century
        production_place_as_recorded       = DS::Extractor::DsCsvExtractor.extract_production_places_as_recorded(record).join '|'
        ...
        uniform_title_as_recorded          = DS::Extractor::DsCsvExtractor.extract_uniform_titles_as_recorded(record).join '|'
        uniform_title_agr                  = DS::Extractor::DsCsvExtractor.extract_uniform_titles_as_recorded_agr(record).join '|'
        title_as_recorded                  = DS::Extractor::DsCsvExtractor.extract_titles_as_recorded(record).join '|'
        title_as_recorded_agr              = DS::Extractor::DsCsvExtractor.extract_titles_as_recorded_agr(record).join '|'
        standard_title                     = Recon::Type::Titles.lookup(title_as_recorded.split('|'), column: 'authorized_label').join '|'
        genre_as_recorded                  = DS::Extractor::DsCsvExtractor.extract_genres_as_recorded(record).join '|'
        genre_label                        = Recon::Type::Genres.lookup(genre_as_recorded.split('|'), [], from_column: 'authorized_label').join '|'
        genre                              = Recon::Type::Genres.lookup(genre_as_recorded.split('|'), [], from_column: 'structured_value').join '|'
        subject_as_recorded                = DS::Extractor::DsCsvExtractor.extract_all_subjects_as_recorded(record).join '|'
        ...
        author_as_recorded                 = DS::Extractor::DsCsvExtractor.extract_authors_as_recorded(record).join '|'
        author_as_recorded_agr             = DS::Extractor::DsCsvExtractor.extract_authors_as_recorded_agr(record).join '|'
        ...
        artist_as_recorded                 = DS::Extractor::DsCsvExtractor.extract_artists_as_recorded(record).join '|'
        artist_as_recorded_agr             = DS::Extractor::DsCsvExtractor.extract_artists_as_recorded_agr(record).join '|'
        ...
        scribe_as_recorded                 = DS::Extractor::DsCsvExtractor.extract_scribes_as_recorded(record).join '|'
        scribe_as_recorded_agr             = DS::Extractor::DsCsvExtractor.extract_scribes_as_recorded_agr(record).join '|'
        ...
        language_as_recorded               = DS::Extractor::DsCsvExtractor.extract_languages_as_recorded(record).join '|'
        ...
        former_owner_as_recorded           = DS::Extractor::DsCsvExtractor.extract_former_owners_as_recorded(record).join '|'
        former_owner_as_recorded_agr       = DS::Extractor::DsCsvExtractor.extract_former_owners_as_recorded_agr(record).join '|'
        ...
        material_as_recorded               = DS::Extractor::DsCsvExtractor.extract_material_as_recorded record
