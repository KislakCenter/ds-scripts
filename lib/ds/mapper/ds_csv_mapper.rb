  ...
  module Mapper
    ...
    class DSCSVMapper < DS::Mapper::BaseMapper
      ...
      def map_record entry
        ...
        genre_label                        = Recon::Genres.lookup(genre_as_recorded.split('|'), [], from_column: 'authorized_label').join '|'
        genre                              = Recon::Genres.lookup(genre_as_recorded.split('|'), [], from_column: 'structured_value').join '|'
