  ...
  module Mapper
    class DSMetsMapper < DS::Mapper::BaseMapper
      ...
      def map_record entry
        ...
        production_place_as_recorded       = DS::Extractor::DsMetsXml.extract_production_places_as_recorded(record).join '|'
        ...
        production_date_as_recorded        = DS::Extractor::DsMetsXml.extract_production_date_as_recorded(record).join '|'
        production_date                    = DS::Extractor::DsMetsXml.transform_production_date record
        century                            = DS.transform_dates_to_centuries production_date
        century_aat                        = DS.transform_centuries_to_aat century
        dated                              = DS::Extractor::DsMetsXml.dated_by_scribe? record
        uniform_title_as_recorded          = ''
        uniform_title_agr                  = ''
        title_as_recorded                  = DS::Extractor::DsMetsXml.extract_titles_as_recorded(record).join '|'
        title_as_recorded_agr              = ''
        standard_title                     = Recon::Titles.lookup(title_as_recorded.split('|'), column: 'authorized_label').join '|'
        genre_as_recorded                  = ''
        genre                              = ''
        genre_label                        = ''
        subject_as_recorded                = DS::Extractor::DsMetsXml.extract_all_subjects_as_recorded(record).join '|'
        ...
        author_as_recorded                 = DS::Extractor::DsMetsXml.extract_authors_as_recorded(record).join '|'
        ...
        artist_as_recorded                 = DS::Extractor::DsMetsXml.extract_artists_as_recorded(record).join '|'
        ...
        scribe_as_recorded                 = DS::Extractor::DsMetsXml.extract_scribes_as_recorded(record).join '|'
        ...
        associated_agent_as_recorded       = DS::Extractor::DsMetsXml.extract_other_names_as_recorded(record).join '|'
        ...
        language_as_recorded               = DS::Extractor::DsMetsXml.extract_languages_as_recorded(record).join '|'
        ...
        former_owner_as_recorded           = DS::Extractor::DsMetsXml.extract_former_owners_as_recorded(record).join '|'
        ...
        material_as_recorded               = DS::Extractor::DsMetsXml.extract_material_as_recorded record
        ...
        physical_description               = DS::Extractor::DsMetsXml.extract_physical_description(record).join '|'
        note                               = DS::Extractor::DsMetsXml.extract_notes(record).join '|'
        acknowledgements                   = DS::Extractor::DsMetsXml.extract_acknowledgments(record).join '|'
