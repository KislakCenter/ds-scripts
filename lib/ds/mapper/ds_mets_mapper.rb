  ...
  module Mapper
    class DSMetsMapper < DS::Mapper::BaseMapper
      ...
      def map_record entry
        ...
        production_place_as_recorded       = DS::Extractor::DS10.extract_production_place record
        ...
        production_date_as_recorded        = DS::Extractor::DS10.extract_date_as_recorded record
        production_date                    = DS::Extractor::DS10.transform_production_date record
        century                            = DS.transform_dates_to_centuries production_date
        century_aat                        = DS.transform_centuries_to_aat century
        dated                              = DS::Extractor::DS10.dated_by_scribe? record
        uniform_title_as_recorded          = ''
        uniform_title_agr                  = ''
        title_as_recorded                  = DS::Extractor::DS10.extract_title record
        title_as_recorded_agr              = ''
        standard_title                     = Recon::Titles.lookup(title_as_recorded.split('|'), column: 'authorized_label').join('|')
        genre_as_recorded                  = ''
        subject_as_recorded                = DS::Extractor::DS10.extract_subjects(record).join '|'
        author_as_recorded                 = DS::Extractor::DS10.extract_author(record).join '|'
        ...
        artist_as_recorded                 = DS::Extractor::DS10.extract_artist(record).join '|'
        ...
        scribe_as_recorded                 = DS::Extractor::DS10.extract_scribe(record).join '|'
        ...
        associated_agent_as_recorded       = DS::Extractor::DS10.extract_other_name(record).join '|'
        ...
        language_as_recorded               = DS::Extractor::DS10.extract_language record
        ...
        former_owner_as_recorded           = DS::Extractor::DS10.extract_ownership(record).join '|'
        ...
        material_as_recorded               = DS::Extractor::DS10.extract_support record
        ...
        physical_description               = DS::Extractor::DS10.extract_physical_description(record).join '|'
        note                               = DS::Extractor::DS10.extract_note(record).join '|'
        acknowledgements                   = DS::Extractor::DS10.extract_acknowledgements(record).join '|'
        data_processed_at                  = timestamp
        data_source_modified               = DS::Extractor::DS10.source_modified
