  ...
  module Mapper
    class TeiXmlMapper < BaseMapper
      ...
      def map_record entry
        ...
        production_date_as_recorded        = DS::TeiXml.extract_production_date_as_recorded record, range_sep: '-'
        production_date                    = DS::TeiXml.extract_production_date_as_recorded record, range_sep: '^'
        ...
        language_as_recorded               = DS::TeiXml.extract_languages_as_recorded record
