  ...
  module Mapper
    class TeiXmlMapper < BaseMapper
      ...
      def map_record entry
        ...
        production_date_as_recorded        = DS::TeiXml.extract_production_date_as_recorded(record, range_sep: '-').join
        production_date                    = DS::TeiXml.extract_production_date_as_recorded(record, range_sep: '^').join
        century                            = DS.transform_dates_to_centuries production_date
        century_aat                        = DS.transform_centuries_to_aat century
        production_place_as_recorded       = DS::TeiXml.extract_production_places_as_recorded(record).join '|'
        ...
        title_as_recorded                  = DS::TeiXml.extract_titles_as_recorded(record).join '|'
        ...
        author_as_recorded_agr             = DS::TeiXml.extract_authors_as_recorded_agr(record).join '|'
        ...
        artist_as_recorded_agr             = DS::TeiXml.extract_artists_as_recorded_agr(record).join '|'
        ...
        scribe_as_recorded_agr             = DS::TeiXml.extract_scribes_as_recorded_agr(record).join '|'
        ...
        language_as_recorded               = DS::TeiXml.extract_languages_as_recorded(record).join '|'
        ...
        former_owner_as_recorded_agr       = DS::TeiXml.extract_former_owners_as_recorded_agr(record).join '|'
        ...
        material_as_recorded               = DS::TeiXml.extract_material_as_recorded record
        ...
        physical_description               = DS::TeiXml.extract_physical_description(record).join '|'
        note                               = DS::TeiXml.extract_notes(record).join '|'
