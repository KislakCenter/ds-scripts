  ...
  module Mapper
    class OPennTEIMapper < BaseMapper
      ...
      def map_record entry
        ...
        production_date_as_recorded        = DS::TeiXml.extract_production_date record, range_sep: '-'
        production_date                    = DS::TeiXml.extract_production_date record, range_sep: '^'
        century                            = DS.transform_dates_to_centuries production_date
        century_aat                        = DS.transform_centuries_to_aat century
        production_place_as_recorded       = DS::TeiXml.extract_production_place(record).join '|'
        ...
        title_as_recorded                  = DS::TeiXml.extract_title_as_recorded(record).join '|'
        title_as_recorded_agr              = DS::TeiXml.extract_title_as_recorded_agr(record).join '|'
        uniform_title_as_recorded          = ''
        uniform_title_agr                  = ''
        standard_title                     = Recon::Titles.lookup(title_as_recorded.split('|'), column: 'authorized_label').join('|')
        genre_as_recorded                  = DS::TeiXml.extract_genre_as_recorded(record).join '|'
        ...
        subject_as_recorded                = DS::TeiXml.extract_subject_as_recorded(record).join '|'
        ...
        author_as_recorded_agr             = DS::TeiXml.extract_authors_agr(record).join '|'
        ...
        artist_as_recorded                 = DS::TeiXml.extract_artists_as_recorded(record).join '|'
        artist_as_recorded_agr             = DS::TeiXml.extract_artists_agr(record).join '|'
        ...
        scribe_as_recorded                 = DS::TeiXml.extract_scribes_as_recorded(record).join '|'
        scribe_as_recorded_agr             = DS::TeiXml.extract_scribes_agr(record).join '|'
        ...
        language_as_recorded               = DS::TeiXml.extract_language_as_recorded record
        ...
        former_owner_as_recorded           = DS::TeiXml.extract_former_owners_as_recorded(record).join '|'
        former_owner_as_recorded_agr       = DS::TeiXml.extract_former_owners_agr(record).join '|'
        ...
        material_as_recorded               = DS::TeiXml.extract_material_as_recorded(record).join '|'
        ...
        acknowledgements                   = DS::TeiXml.extract_acknowledgments(record).join '|'
        physical_description               = DS::TeiXml.extract_physical_description record
        note                               = DS::TeiXml.extract_note(record).join '|'
