    ...
    module MarcXML
      module ClassMethods
        ...
        def extract_recon_titles record
          ...
          tar_agr  = DS::Extractor::MarcXML.extract_title_agr record, 245
          utar     = DS::Extractor::MarcXML.extract_uniform_title_as_recorded record
          utar_agr = DS::Extractor::MarcXML.extract_uniform_title_agr record
