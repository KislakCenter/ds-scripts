...
CSV headers: true do |csv|
  ...
  xml_files.each do |file|
    ...
    holding_institution_as_recorded = DS::DsMetsXml.extract_institution_name(record)
    holding_institution_shelfmark   = DS::DsMetsXml.extract_shelfmark(record)
    ...
    row                             = {
      ...
      holding_institution_institutional_id: DS::DsMetsXml.extract_shelfmark(record),
