...
CSV headers: true do |csv|
  ...
  xml_files.each do |file|
    ...
    holding_institution_as_recorded = DS::Extractor::DsMetsXmlExtractor.extract_institution_name(record)
    holding_institution_shelfmark   = DS::Extractor::DsMetsXmlExtractor.extract_shelfmark(record)
    ...
    row                             = {
      ...
      holding_institution_institutional_id: DS::Extractor::DsMetsXmlExtractor.extract_shelfmark(record),
      ...
      title:                                DS::Extractor::DsMetsXmlExtractor.extract_titles_as_recorded(record),
