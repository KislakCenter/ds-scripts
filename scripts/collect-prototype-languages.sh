...
# Convert CSV format
${SCRIPT_DIR}/../bin/recon languages -o ${TMP_DIR} -a legacy -t mets $files
...
do
  ${SCRIPT_DIR}/../bin/recon languages -o ${TMP_DIR} -a ${inst} -t marc ${SCRIPT_DIR}/../data/prototype-data/${inst}/*.xml
done
...
do
  ${SCRIPT_DIR}/../bin/recon languages -o ${TMP_DIR} -a ${inst} -t tei ${SCRIPT_DIR}/../data/prototype-data/${inst}/*.xml
done
