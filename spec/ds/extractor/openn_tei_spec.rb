...
RSpec.describe 'DS::Extractor::OPennTEI' do
  before do
    # Do nothing
  end
  ...
  context 'extract_note' do
    ...
    let(:notes) { DS::Extractor::OPennTEI.extract_note tei_xml }
  ...
  context 'names' do
    ...
    context 'authors' do
      ...
      context 'extract_authors_as_recorded' do
        let(:authors) { DS::Extractor::OPennTEI.extract_authors_as_recorded tei_xml }
      ...
      context 'extract_authors_agr_as_recorded' do
        let(:authors) { DS::Extractor::OPennTEI.extract_authors_as_recorded tei_xml }
        let(:authors_agr) { DS::Extractor::OPennTEI.extract_authors_agr tei_xml }
    ...
    context 'extract_resps' do
      let(:resps) { DS::Extractor::OPennTEI.extract_resps tei_xml, 'former owner' }
    ...
    context 'former owners' do
      context 'extract_former_owners' do
        let(:former_owners) { DS::Extractor::OPennTEI.extract_former_owners_as_recorded tei_xml }
      ...
      context 'extract_former_owners_agr' do
        let(:former_owners) { DS::Extractor::OPennTEI.extract_former_owners_as_recorded tei_xml }
        let(:former_owners_agr) { DS::Extractor::OPennTEI.extract_former_owners_agr tei_xml }
    ...
    context 'artists' do
      context 'extract_artists' do
        let(:artists) { DS::Extractor::OPennTEI.extract_artists_as_recorded tei_xml }
      ...
      context 'extract_artists_agr' do
        let(:artists) { DS::Extractor::OPennTEI.extract_artists_as_recorded tei_xml }
        let(:artists_agr) { DS::Extractor::OPennTEI.extract_artists_agr tei_xml }
    ...
    context 'scribes' do
      context 'extract_scribes' do
        let(:scribes) { DS::Extractor::OPennTEI.extract_scribes_as_recorded tei_xml }
      ...
      context 'extract_scribes_agr' do
        let(:scribes) { DS::Extractor::OPennTEI.extract_scribes_as_recorded tei_xml }
        let(:scribes_agr) { DS::Extractor::OPennTEI.extract_scribes_agr tei_xml }
  ...
  context 'extract_acknowledgments' do
    ...
    let(:acknowledgments) { DS::Extractor::OPennTEI.extract_acknowledgments tei_xml }
    let(:catalogers) {
  ...
  context 'titles' do
    ...
    let(:titles) {
      DS::Extractor::OPennTEI.extract_title_as_recorded tei_xml
    }

    let(:titles_agr) {
      DS::Extractor::OPennTEI.extract_title_as_recorded_agr tei_xml
    }

    let(:recon_titles) {
      DS::Extractor::OPennTEI.extract_recon_titles tei_xml
    }
  ...
  context 'extract_physical_description' do
    ...
    let(:phys_desc) { DS::Extractor::OPennTEI.extract_physical_description tei_xml }
    ...
    context 'extract_material_as_recorded' do
      let(:material) { DS::Extractor::OPennTEI.extract_material_as_recorded tei_xml }
  ...
  context 'holding information' do
    ...
    context 'extract_holding_institution' do
      let(:holding_institution) { DS::Extractor::OPennTEI.extract_holding_institution tei_xml }
    ...
    context 'extract_holding_institution_id_nummber' do
      let(:id_number) { DS::Extractor::OPennTEI.extract_holding_institution_id_nummber tei_xml }
    ...
    context 'extract_shelfmark' do
      let(:shelfmark) { DS::Extractor::OPennTEI.extract_shelfmark tei_xml }
    ...
    context 'extract_link_to_record' do
      let(:url) { DS::Extractor::OPennTEI.extract_link_to_record tei_xml }
  ...
  context 'history' do
    ...
    context 'extract_production_place' do
      let(:place) { DS::Extractor::OPennTEI.extract_production_place tei_xml }
    ...
    context 'extract_production_date' do
      let(:date) { DS::Extractor::OPennTEI.extract_production_date tei_xml, range_sep: '-' }
