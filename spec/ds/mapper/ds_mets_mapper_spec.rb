...
RSpec.describe 'DS::Mapper::DSMetsMapper' do
  ...
  let(:manifest_csv) { parse_csv <<~EOF
    ...
    Q1976985,The Nelson-Atkins Museum of Art ,,ds-mets,ds_mets-nelson-atkins-kg40.xml,KG 40,KG 40,"/mets:mets[./mets:dmdSec/mets:mdWrap/mets:xmlData/mods:mods/mods:identifier[@type = 'local' and ./text() = 'ID_PLACEHOLDER']]",KG 40,https://archive.org/details/KG40_46,2016-09-13T08:51:34,"Book of Hours, excerpt Hours of the Cross",https://iiif.archivelab.org/iiif/images_KG40_46/manifest.json,FALSE,2023-12-16T12:51:52-0500
    EOF
  }
