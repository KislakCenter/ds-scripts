...
EOF
  ...
  let(:manifest) { 'manifest.csv' }

  let(:validator) { DS::ManifestValidator.new csv_data, marc_xml_dir }
  ...
  context 'initialize' do
    ...
    it 'creates a new ManifestValidator with parsed CSV' do
      expect(
        DS::ManifestValidator.new csv_data, marc_xml_dir
      ).to be_a DS::ManifestValidator
    end
    ...
    it 'creates a new ManifestValidator from an StringIO instance' do
      expect(
        DS::ManifestValidator.new csv_stringio, marc_xml_dir
      ).to be_a DS::ManifestValidator
    end

    let(:manifest_path) { File.join marc_xml_dir, manifest }
    it 'creates a new ManifestValidator from a manifest path' do
      expect(
        DS::ManifestValidator.new manifest_path, marc_xml_dir
      ).to be_a DS::ManifestValidator
    end
    ...
    it 'creates a new ManifestValidator from an IO instance' do
      expect(
        DS::ManifestValidator.new csv_io, marc_xml_dir
      ).to be_a DS::ManifestValidator
    end
  end
